...
function FileUploader({ fieldChange, mediaUrl }: FileUploaderProps) {
  ...
  return (
    <div className='flex flex-center flex-col pg-dark-3 rounded-xl cursor-pointer' {...getRootProps()}>
            ...
            fileUrl ? (
                ...
                <div className='file_uploader-box'>
                    <img 
                        ...
                        alt='file-upload'
                    />
                    <h3 className='base-medium text-light-2 mb-3 mt-6'>Drag Photo here</h3>
